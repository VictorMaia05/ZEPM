		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#tra0521epm0521-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tra0521epm0521-display": {
								"semanticObject": "tra0521epm0521",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tra0521.epm0521",
									"url": sap.ui.require.toUrl("tra0521/epm0521")
								}
							}
						}
					}
